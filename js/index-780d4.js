(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":720,"designHeight":1280,"screenMode":"vertical","backgroundColor":"rgba(86, 192, 202, 1)","scaleMode":"fixedheight","alignV":"top","alignH":"left"},"2D":{"defaultFont":"MicrosoftYaHei","FPS":60,"isAntialias":true,"useRetinalCanvas":false,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFontSize":20},"3D":{"lightClusterCount":{"x":12,"y":12,"z":12},"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"maxMorphTargetCount":32},"physics2D":{"gravity":{"y":500,"x":0},"allowSleeping":true,"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false},"splash":{"enabled":false,"backgroundColor":"rgba(11, 237, 232, 1)","image":"resources/layaAir.png","fit":"center","duration":1},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"startupScene":"Scene.ls","useSafeFileExtensions":true,"pkgs":[{"path":"","hash":"5222b"}]}`);
